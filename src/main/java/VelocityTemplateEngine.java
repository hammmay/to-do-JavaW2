//include the same code for our Spark-to-Velocity adapter in the src/main/java/VelocityTemplateEngine.java file. Remember, this allows the Velocity Template Engine to integrate seamlessly with the Spark framework:
